...
| — | **Cross-machine** | ✅ RPC **and** pub/sub over `203.0.113.103` with `--bind 0.0.0.0`, not loopback |
...
Verified over a second local network interface (`203.0.113.103`), not a second
