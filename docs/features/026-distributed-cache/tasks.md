...
- [-] T1 — `HighwayCache` core: `IDistributedCache`
...
- [~] T3 — Registration: `AddHighway` auto-registers cache
...
- [~] T4 — Registration: standalone `AddHighwayCache`
...
- [~] T5 — Connection sharing when both paths coexist
...
- [~] T6 — Prove `HybridCache` works with Highway as L2
...
- [~] T7 — Storefront sample: cache an order lookup
...
- [~] T8 — UserGuide: Distributed Cache section
...
- [~] T9 — product.md implementation status update
  *Requirements:* R8.3
  *Depends on:* T6
