...
### - [x] T0 — The paper decisions *(no code)*
...
### - [x] T1 — Encoder property tests over the existing draft
...
### - [x] T2 — Contract suite + `InMemoryStore` first
...
### - [x] T3 — `RocksDbStore`: open, CFs, families
...
### - [x] T4 — In-batch seq allocation + head-push scheme
...
### - [x] T6 — Fault injection + crash-replay
...
### - [x] T7 — Gate G1 + single-commit + no-clock + packaging *(gate G1)*
