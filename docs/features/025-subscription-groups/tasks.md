...
### - [ ] T1 — `SubscriptionGroup` option, validated
...
### - [ ] T2 — The claimant becomes the group (client)
...
### - [ ] T3 — Compete and replicate, proven
...
### - [ ] T4 — `HW.SUBSCRIBE` carries the node; membership mirror maintained
...
### - [ ] T6 — `BYE PURGE` respects shared groups
...
### - [ ] T7 — Idempotency dedups across replicas
...
### - [ ] T8 — Dashboard shows members; no dashboard tests
...
### - [ ] T9 — Constraints, protocol invariants, deferred register
...
### - [ ] T10 — UserGuide rule 3 and the samples
